...
class Inventory:
    ...
    def search(self, keyword: str) -> list[Product]:
        ...
        [product for product in self.products.values() if keyword in product]
    ...
    def in_stock(self) -> list[Product]:
        ...
        return [product for product in self.products.values() if product]
    ...
    def summary(self) -> dict:
        ...
        return{
            ...
            "out_of_stock_count": sum(1 for product in self.products.values() if not product)
        }
